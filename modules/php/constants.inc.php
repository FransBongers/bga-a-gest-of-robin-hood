...
const RIDE = 'RIDE';
// Events
const EVENT_AMBUSH_DARK = 'EVENT_AMBUSH_DARK';
const EVENT_A_TALE_OF_TWO_LOVERS_LIGHT = 'EVENT_A_TALE_OF_TWO_LOVERS_LIGHT';
const EVENT_BOATS_BRIDGES_DARK = 'EventBoatsBridgesDark';
const EVENT_BOATS_BRIDGES_LIGHT = 'EventBoatsBridgesLight';
