...
const ST_EVENT_GREAT_ESCAPE_LIGHT = 66;
...
const ST_EVENT_REPLACE_HENCHMEN = 71;
const ST_EVENT_WILL_STUTELY_LIGHT = 72;
const ST_EVENT_ROYAL_PARDON_LIGHT = 73;
const ST_EVENT_MAID_MARIAN_DARK = 74;
...
const ROYAL_INSPECTION_MOVE_MARKER = 'ROYAL_INSPECTION_MOVE_MARKER';
...
const EVENT_GREAT_ESCAPE_LIGHT = 'EVENT_GREAT_ESCAPE_LIGHT';
const EVENT_GUY_OF_GISBORNE = 'EVENT_GUY_OF_GISBORNE';
const EVENT_MAID_MARIAN_DARK = 'EVENT_MAID_MARIAN_DARK';
const EVENT_REPLACE_HENCHMEN  = 'EVENT_REPLACE_HENCHMEN ';
const EVENT_ROYAL_PARDON_LIGHT = 'EVENT_ROYAL_PARDON_LIGHT';
const EVENT_SELECT_FORCES = 'EVENT_SELECT_FORCES';
const EVENT_SELECT_SPACE = 'EVENT_SELECT_SPACE';
const EVENT_WILL_STUTELY_LIGHT = 'EVENT_WILL_STUTELY_LIGHT';
// Fortune Event
...
const FORTUNE_EVENT_WARDEN_OF_THE_FOREST_RESULT = 'FORTUNE_EVENT_WARDEN_OF_THE_FOREST_RESULT';
...
const PARISHES_AND_NOTTINGHAM = [BINGHAM, BLYTH, MANSFIELD, NEWARK, REMSTON, RETFORD, TUXFORD, NOTTINGHAM];
