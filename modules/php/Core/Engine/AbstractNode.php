...
namespace AGestOfRobinHood\Core\Engine;
...
class AbstractNode
{
  ...
  public function insertAsBrother($newNode)
  {
    ...
    if (!$this->parent instanceof \AGestOfRobinHood\Core\Engine\SeqNode) {
      $newParent = new \AGestOfRobinHood\Core\Engine\SeqNode([], []);
