...
class RoyalInspectionReset extends \AGestOfRobinHood\Models\AtomicAction
{
  public function getState()
  {
    return ST_ROYAL_INSPECTION_RESET;
  }
  ...
  public function stRoyalInspectionReset()
  {
    ...
    $markers[ROBIN_HOOD_ELIGIBILITY_MARKER]->setLocation(Locations::initiativeTrack(FIRST_ELIGIBLE));
    $markers[SHERIFF_ELIGIBILITY_MARKER]->setLocation(Locations::initiativeTrack(SECOND_ELIGIBLE));
  ...
  public function argsRoyalInspectionReset()
  {
    $data = [];
  ...
  public function actPassRoyalInspectionReset()
  {
  ...
  public function actRoyalInspectionReset($args)
  {
    self::checkAction('actRoyalInspectionReset');
