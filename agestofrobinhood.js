...
var GestManualPositionStock = (function (_super) {
    ...
    return GestManualPositionStock;
}(CardStock));
...
var tplSpaces = function () {
    return Object.entries(SPACES_CONFIG)
        ...
        var html = '';
        Object.keys(config).forEach(function (forceType) {
            html += "<div id=\"".concat(forceType, "_").concat(spaceId, "\" class=\"gest_forces\" style=\"top: calc(var(--gestMapScale) * ").concat(config[forceType].top, "px); left: calc(var(--gestMapScale) * ").concat(config[forceType].left, "px); width: calc(var(--gestMapScale) * 10px); height: calc(var(--gestMapScale) * 10px);\"></div>");
        });
        return html;
    })
        .join('');
...
var campDisplay = function (positions) {
    return function (element, cards, lastCard, stock) {
        cards.forEach(function (force, index) {
            var forceDiv = stock.getCardElement(force);
            forceDiv.style.top = "calc(var(--gestForceScale) * ".concat(positions[index > 1 ? 0 : index].top, "px)");
            forceDiv.style.left = "calc(var(--gestForceScale) * ".concat(positions[index > 1 ? 0 : index].left, "px)");
            forceDiv.style.zIndex = positions[index].zIndex + '';
        });
    };
};
var CARRIAGE_WIDTH = 56;
var CARRIAGE_HEIGHT = 56;
var HENCHMAN_WIDTH = 40;
var HENCHMAN_HEIGHT = 50;
var MERRY_MAN_WIDTH = 40;
var MERRY_MAN_HEIGHT = 46;
var forceDisplay = function (coordinates, width, height) {
    return function (element, cards, lastCard, stock) {
        cards.forEach(function (force, index) {
            var _a, _b, _c, _d;
            var forceDiv = stock.getCardElement(force);
            var row = (_b = (_a = coordinates[index]) === null || _a === void 0 ? void 0 : _a.row) !== null && _b !== void 0 ? _b : 10;
            var column = (_d = (_c = coordinates[index]) === null || _c === void 0 ? void 0 : _c.column) !== null && _d !== void 0 ? _d : 10;
            var top = row * 0.5 * height;
            var left = column * width - (row % 2) * 0.5 * width;
            forceDiv.style.top = "calc(var(--gestForceScale) * ".concat(top, "px)");
            forceDiv.style.left = "calc(var(--gestForceScale) * ".concat(left, "px)");
            forceDiv.style.zIndex = row + '';
        });
    };
};
var getDisplayFunction = function (spaceId, forceType) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    var displayFunctionMap = (_a = {},
        _a[BINGHAM] = (_b = {},
            _b[HENCHMEN] = forceDisplay(binghamHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _b[MERRY_MEN] = forceDisplay(defaultMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _b[CAMP] = campDisplay(defaultCampPositions),
            _b[CARRIAGE] = forceDisplay(binghamCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _b),
        _a[BLYTH] = (_c = {},
            _c[HENCHMEN] = forceDisplay(defaultHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _c[MERRY_MEN] = forceDisplay(defaultHenchmenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _c[CAMP] = campDisplay(defaultCampPositions),
            _c[CARRIAGE] = forceDisplay(blythCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _c),
        _a[MANSFIELD] = (_d = {},
            _d[HENCHMEN] = forceDisplay(mansfieldHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _d[MERRY_MEN] = forceDisplay(mansfieldMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _d[CAMP] = campDisplay(defaultCampPositions),
            _d[CARRIAGE] = forceDisplay(mansfieldCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _d),
        _a[NEWARK] = (_e = {},
            _e[HENCHMEN] = forceDisplay(newarkHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _e[MERRY_MEN] = forceDisplay(defaultMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _e[CAMP] = campDisplay(defaultCampPositions),
            _e[CARRIAGE] = forceDisplay(newarkCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _e),
        _a[NOTTINGHAM] = (_f = {},
            _f[HENCHMEN] = forceDisplay(nottinghamHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _f[MERRY_MEN] = forceDisplay(nottinghamMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _f[CAMP] = campDisplay(defaultCampPositions),
            _f[CARRIAGE] = forceDisplay(nottinghamCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _f),
        _a[OLLERTON_HILL] = (_g = {},
            _g[HENCHMEN] = forceDisplay(mansfieldHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _g[MERRY_MEN] = forceDisplay(mansfieldMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _g[CAMP] = campDisplay(defaultCampPositions),
            _g[CARRIAGE] = forceDisplay(mansfieldCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _g),
        _a[REMSTON] = (_h = {},
            _h[HENCHMEN] = forceDisplay(defaultHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _h[MERRY_MEN] = forceDisplay(defaultMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _h[CAMP] = campDisplay(defaultCampPositions),
            _h[CARRIAGE] = forceDisplay(remstonCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _h),
        _a[RETFORD] = (_j = {},
            _j[HENCHMEN] = forceDisplay(retfordHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _j[MERRY_MEN] = forceDisplay(refordMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _j[CAMP] = campDisplay(defaultCampPositions),
            _j[CARRIAGE] = forceDisplay(retfordCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _j),
        _a[SHIRE_WOOD] = (_k = {},
            _k[HENCHMEN] = forceDisplay(shireWoodHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _k[MERRY_MEN] = forceDisplay(shireWoodMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _k[CAMP] = campDisplay(defaultCampPositions),
            _k[CARRIAGE] = forceDisplay(shireWoodCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _k),
        _a[SOUTHWELL_FOREST] = (_l = {},
            _l[HENCHMEN] = forceDisplay(southwellForestHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _l[MERRY_MEN] = forceDisplay(southwellForestMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _l[CAMP] = campDisplay(southwellForestCampPositions),
            _l[CARRIAGE] = forceDisplay(southwellForestCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _l),
        _a[TUXFORD] = (_m = {},
            _m[HENCHMEN] = forceDisplay(defaultHenchmenCoordinates, HENCHMAN_WIDTH, HENCHMAN_HEIGHT),
            _m[MERRY_MEN] = forceDisplay(defaultMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _m[CAMP] = campDisplay(defaultCampPositions),
            _m[CARRIAGE] = forceDisplay(tuxfordCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT),
            _m),
        _a[PRISON] = (_o = {},
            _o[MERRY_MEN] = forceDisplay(defaultMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT),
            _o),
        _a);
    return displayFunctionMap[spaceId][forceType];
};
var binghamCarriageCoordinates = [
    {
        row: 2,
        column: 0,
    },
...
var binghamHenchmenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var defaultCarriageCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var defaultHenchmenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var defaultMerryMenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var mansfieldCarriageCoordinates = [
    {
        row: 3,
        column: 0,
    },
...
var mansfieldHenchmenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var mansfieldMerryMenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var nottinghamCarriageCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var nottinghamHenchmenCoordinates = [
    {
        row: 2,
        column: 1,
    },
...
var nottinghamMerryMenCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var remstonCarriageCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var retfordCarriageCoordinates = [
    {
        row: 2,
        column: 0,
    },
...
var retfordHenchmenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var shireWoodCarriageCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var shireWoodHenchmenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var shireWoodMerryMenCoordinates = [
    {
        row: 2,
        column: 1,
    },
...
var southwellForestCampPositions = [
    {
        top: 0,
        left: 0,
        zIndex: 0,
...
var southwellForestCarriageCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var southwellForestHenchmenCoordinates = [
    {
        row: 1,
        column: 1,
    },
...
var southwellForestMerryMenCoordinates = [
    {
        row: 4,
        column: 0,
    },
...
var tuxfordCarriageCoordinates = [
    {
        row: 0,
        column: 0,
    },
...
var robSummaryInfo = function (_a) {
    ...
    return "\n  <div>\n      ".concat(robSummarySteps()
        ...
        .join(''), "\n    </div>\n    <div style=\"margin-top: 16px;\">\n      <span class=\"gest_title\"\">").concat(_('Green die faces'), "</span>\n      <div class=\"gest_row\" style=\"margin-top: 4px;\">\n        ").concat(tplLogTokenDieResult('green:-1'), "\n        ").concat(tplLogTokenDieResult('green:-1'), "\n        ").concat(tplLogTokenDieResult('green:0'), "\n        ").concat(tplLogTokenDieResult('green:1'), "\n        ").concat(tplLogTokenDieResult('green:2'), "\n        ").concat(tplLogTokenDieResult('green:3'), "\n      </div>\n    </div>\n        <div style=\"margin-top: 16px;\">\n      <span class=\"gest_title\"\">").concat(_('White die faces'), "</span>\n      <div class=\"gest_row\" style=\"margin-top: 4px;\">\n        ").concat(tplLogTokenDieResult('white:-2'), "  \n        ").concat(tplLogTokenDieResult('white:-1'), "\n        ").concat(tplLogTokenDieResult('white:-1'), "\n        ").concat(tplLogTokenDieResult('white:0'), "\n        ").concat(tplLogTokenDieResult('white:1'), "\n        ").concat(tplLogTokenDieResult('white:2'), "\n      </div>\n    </div>\n  </div>\n");
};
...
var RecruitState = (function () {
    ...
    RecruitState.prototype.updateInterfaceConfirm = function (_a) {
        ...
        var text = _('Pay ${cost} ${tkn_shilling} to place ${merryMenLog} in ${spaceName}?');
        if (recruitOption === REPLACE_MERRY_MAN_WITH_CAMP) {
            text = _('Pay ${cost} ${tkn_shilling} to replace ${tkn_merryMan} in ${spaceName} with ${tkn_camp}?');
        }
        else if (recruitOption === FLIP_ALL_MERRY_MAN_TO_HIDDEN) {
            text = _('Pay ${cost} ${tkn_shilling} to flip all ${tkn_merryMan_revealed} in ${spaceName} to ${tkn_merryMan_hidden}?');
        }
        var args = {
