    ...
    GameMap.prototype.setupForces = function (_a) {
        ...
        Object.entries(SPACES_CONFIG).forEach(function (_a) {
            ...
            Object.keys(config).forEach(function (forceType) {
                ...
                _this.forces[id] = new ManualPositionStock(_this.game.forceManager, element, {}, getDisplayFunction(spaceId, forceType));
            });
        });
        this.forces['Carriage_usedCarriages'] = new ManualPositionStock(this.game.forceManager, document.getElementById('Carriage_usedCarriages'), {}, forceDisplay(defaultCarriageCoordinates, CARRIAGE_WIDTH, CARRIAGE_HEIGHT));
        this.forces["".concat(MERRY_MEN, "_prison")] = new ManualPositionStock(this.game.forceManager, document.getElementById("".concat(MERRY_MEN, "_prison")), {}, forceDisplay(defaultMerryMenCoordinates, MERRY_MAN_WIDTH, MERRY_MAN_HEIGHT));
        this.updateForces({ gamedatas: gamedatas });
    };
...
var campDisplay = function (positions) { return function (element, cards, lastCard, stock) {
...
var forceDisplay = function (coordinates, width, height) { return function (element, cards, lastCard, stock) {
    cards.forEach(function (force, index) {
        var _a, _b, _c, _d;
        var forceDiv = stock.getCardElement(force);
