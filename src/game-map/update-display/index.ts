const campDisplay =
  ...
  (
    ...
    cards: GestForce[],
    lastCard: GestForce,
    stock: GestManualPositionStock<GestForce>
    // lastCardOnly = false
  ) => {
...
const forceDisplay =
  (coordinates: ForceCoordinates[], width: number, height: number) =>
  (
    element: HTMLElement,
    cards: GestForce[],
    lastCard: GestForce,
    ...
    cards.forEach((force, index) => {
      ...
      // if (!lastCardOnly || (lastCardOnly && force.id === lastCard.id)) {
...
const getDisplayFunction = (spaceId: string, forceType: string) => {
  const displayFunctionMap = {
    [BINGHAM]: {
      [HENCHMEN]: forceDisplay(
        binghamHenchmenCoordinates,
        HENCHMAN_WIDTH,
        HENCHMAN_HEIGHT
      ),
      [MERRY_MEN]: forceDisplay(
        defaultMerryMenCoordinates,
        MERRY_MAN_WIDTH,
        MERRY_MAN_HEIGHT
      ),
      [CAMP]: campDisplay(defaultCampPositions),
      [CARRIAGE]: forceDisplay(
        binghamCarriageCoordinates,
        CARRIAGE_WIDTH,
        CARRIAGE_HEIGHT
      ),
    },
    ...
    [MANSFIELD]: {
      [HENCHMEN]: forceDisplay(
        mansfieldHenchmenCoordinates,
        HENCHMAN_WIDTH,
        HENCHMAN_HEIGHT
      ),
      [MERRY_MEN]: forceDisplay(
        mansfieldMerryMenCoordinates,
        MERRY_MAN_WIDTH,
        MERRY_MAN_HEIGHT
      ),
      [CAMP]: campDisplay(defaultCampPositions),
      [CARRIAGE]: forceDisplay(
        mansfieldCarriageCoordinates,
        CARRIAGE_WIDTH,
        CARRIAGE_HEIGHT
      ),
    },
    ...
    [NOTTINGHAM]: {
      [HENCHMEN]: forceDisplay(
        nottinghamHenchmenCoordinates,
        HENCHMAN_WIDTH,
        HENCHMAN_HEIGHT
      ),
      [MERRY_MEN]: forceDisplay(
        nottinghamMerryMenCoordinates,
        MERRY_MAN_WIDTH,
        MERRY_MAN_HEIGHT
      ),
      [CAMP]: campDisplay(defaultCampPositions),
      [CARRIAGE]: forceDisplay(
        nottinghamCarriageCoordinates,
        CARRIAGE_WIDTH,
        CARRIAGE_HEIGHT
      ),
    },
    ...
    [RETFORD]: {
      [HENCHMEN]: forceDisplay(
        retfordHenchmenCoordinates,
        HENCHMAN_WIDTH,
        HENCHMAN_HEIGHT
      ),
      [MERRY_MEN]: forceDisplay(
        refordMerryMenCoordinates,
        MERRY_MAN_WIDTH,
        MERRY_MAN_HEIGHT
      ),
      [CAMP]: campDisplay(defaultCampPositions),
      [CARRIAGE]: forceDisplay(
        retfordCarriageCoordinates,
        CARRIAGE_WIDTH,
        CARRIAGE_HEIGHT
      ),
    },
    [SHIRE_WOOD]: {
      [HENCHMEN]: forceDisplay(
        shireWoodHenchmenCoordinates,
        HENCHMAN_WIDTH,
        HENCHMAN_HEIGHT
      ),
      [MERRY_MEN]: forceDisplay(
        shireWoodMerryMenCoordinates,
        MERRY_MAN_WIDTH,
        MERRY_MAN_HEIGHT
      ),
      [CAMP]: campDisplay(defaultCampPositions),
      [CARRIAGE]: forceDisplay(
        shireWoodCarriageCoordinates,
        CARRIAGE_WIDTH,
        CARRIAGE_HEIGHT
      ),
    },
    [SOUTHWELL_FOREST]: {
      [HENCHMEN]: forceDisplay(
        southwellForestHenchmenCoordinates,
        HENCHMAN_WIDTH,
        HENCHMAN_HEIGHT
      ),
      [MERRY_MEN]: forceDisplay(
        southwellForestMerryMenCoordinates,
        MERRY_MAN_WIDTH,
        MERRY_MAN_HEIGHT
      ),
      [CAMP]: campDisplay(southwellForestCampPositions),
      [CARRIAGE]: forceDisplay(
        southwellForestCarriageCoordinates,
        CARRIAGE_WIDTH,
        CARRIAGE_HEIGHT
      ),
    },
