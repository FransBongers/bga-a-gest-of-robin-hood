class IconCounter {
  ...
  setup({icon, initialValue, extraIconClasses, insert, dataAttributes}: IconCounterConfig) {
    ...
    container.insertAdjacentHTML(
      insert || "beforeend",
      tplIconCounter({ extraIconClasses, icon, iconCounterId: this.iconCounterId, value: initialValue, dataAttributes })
    );
